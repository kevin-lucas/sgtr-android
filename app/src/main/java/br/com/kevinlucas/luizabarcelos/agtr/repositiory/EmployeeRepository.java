...
import br.com.kevinlucas.luizabarcelos.agtr.model.Employee;
...
public class EmployeeRepository {
    ...
    private Employee employee; // referência do colaborador
    ...
    public void saveAll(String name, final Context context) {
        ...
        employee = new Employee(getId(name), name, getDate(), getTime());
        ...
        databaseReference = FirebaseConf.getDatabaseReference()
                ...
                .child("lunches")
                .child(employee.getDate().replace("/", ""));
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getValue() == null) {
                    ...
                    saveLanch(context, employee.getName());
                }
            }
    ...
    private void saveLanch(Context context, String msg) {
        ...
        databaseReference
                ...
                .child(getDate().replace("/", ""))
                .child("time")
                .setValue(employee.getTime());
        // Exibe uma mesagem na tela informado o sucesso da operação
        Toast.makeText(context, "Colaborador: " + msg, Toast.LENGTH_SHORT).show();
    ...
    // Retorna o id do colaborador trasformado utilizando um codificador que utiliza o nome como parâmetro
